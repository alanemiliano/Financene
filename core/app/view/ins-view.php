         ...
         <?php foreach($ops as $op):?>
           <tr>
             ...
             <td style="width:200px;">
              <a href="./?view=ins&opt=edit&id=<?php echo $op->id;?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i> Editar</a>
              <a href="./?action=operations&opt=delin&id=<?php echo $op->id;?>&k=1" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Eliminar</a>

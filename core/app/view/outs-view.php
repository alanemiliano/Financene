         ...
         <?php foreach($ops as $op):?>
           <tr>
             ...
             <td style="width:200px;">
              <a href="./?view=outs&opt=edit&id=<?php echo $op->id;?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i> Editar</a>

              <a href="./?action=operations&opt=delout&id=<?php echo $op->id;?>&k=1" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Eliminar</a>
          ...
          <div class="col-md-8">
            <form method="post" action="./?action=operations&opt=addout">
              <div class="form-group">
                <label class="" for="exampleInputEmail1">Fecha (día-mes-año)</label>
...
if($x->kind!=2){ Core::redir("./?view=outs&opt=all");}
  ?>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-8">
            <form method="post" action="./?action=operations&opt=updateout">
              <div class="form-group">
                <label for="exampleInputEmail1">Fecha (día-mes-año)</label>
